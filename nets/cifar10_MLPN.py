...
# Сеть
model = Sequential()
model.add(Dense(5000, input_shape=(RESHAPED,), activation='relu'))
...
open('cifar10_MLPN.json', 'w').write(model_json)
model.save_weights('cifar10_weights_MLPN.h5', overwrite=True)
